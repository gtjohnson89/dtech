...
<body>
  ...
  <header class="hero"><div class="shell">
    <nav class="topbar" aria-label="Dashboard navigation"><a class="brand" href="#top"><span class="brand-mark">D</span><span><b>Build OS</b><small>Dementia tech lab</small></span></a><div class="top-links"><a href="#research" data-open-section="research">Research</a><a href="#projects" data-open-section="projects">Projects</a></div></nav>
  <div class="hero-grid" id="top"><div><p class="eyebrow amber">Dementia Tech Lab</p><h1>From caregiver insight<br>to <em>useful tools.</em></h1><p class="hero-copy">Daily research finds recurring care challenges. The most promising ideas become projects to explore.</p></div></div>
  </div></header>
  <main class="shell">
  ...
  <footer class="shell footer"><p><b>Dementia Tech Build OS</b></p><p>Research → ideas → projects · updated ${esc(formatDate(latest && latest.date))}</p></footer>
