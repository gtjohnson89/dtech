 ...
 * Usage from this directory: node build.js
 * Usage from the repository root: node site/build.js
 */
const fs = require("fs");
...
<body>
  ...
  <footer class="shell footer"><p><b>Dementia Tech Build OS</b> · local static dashboard</p><p>Sources: <code>./log.jsonl</code> · <code>./projects/*.json</code> · <code>./carts/*.json</code> · rebuild with <code>node site/build.js</code></p></footer>
